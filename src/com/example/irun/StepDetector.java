...
public class StepDetector implements SensorEventListener {
	...
	public StepDetector(Context context) {
		...
		if (StepSettingFragment.sharedPreferences == null) {
			StepSettingFragment.sharedPreferences = context.getSharedPreferences(
					StepSettingFragment.SETP_SHARED_PREFERENCES,
					Context.MODE_PRIVATE);
		}
		SENSITIVITY = StepSettingFragment.sharedPreferences.getInt(
				StepSettingFragment.SENSITIVITY_VALUE, 3);
	}
